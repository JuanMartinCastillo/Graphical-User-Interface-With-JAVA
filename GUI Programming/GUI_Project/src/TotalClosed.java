...
public class TotalClosed extends JFrame implements WindowListener {
    public TotalClosed(){
    	...
    	try {
    	    ...
    	    rs = stmt.executeQuery("select * from tickets WHERE status = 'closed';");
    	    ...
    	    String[] colNames = {"Ticket Number", "Tech in charge","Date opened", "Date Closed"};
    	  ...
    	  //  total.setLayout(new GridLayout());
    	    //JLabel TOTAL = new JLabel("                    " + "CLOSED TICKETS: " + counter);
    	  //  total.add(TOTAL);
